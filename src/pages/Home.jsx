...
function Home() {
  ...
  const recommendedRecipes = useMemo(() => recipes.slice(3, 12), [recipes])
            ...
            >
              ...
              {loading ? (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-white dark:bg-dark-card rounded-xl border dark:border-dark-border overflow-hidden animate-pulse">
                      <div className="h-32 bg-gray-200 dark:bg-dark-border"></div>
                      <div className="p-3">
                        <div className="h-4 bg-gray-200 dark:bg-dark-border rounded mb-2"></div>
                        <div className="h-3 bg-gray-200 dark:bg-dark-border rounded w-2/3"></div>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div key={i} className="bg-white dark:bg-dark-card rounded-xl border dark:border-dark-border overflow-hidden animate-pulse">
                      ...
                      <div className="p-4 space-y-3">
                        <div className="h-4 bg-gray-200 dark:bg-dark-border rounded"></div>
                        <div className="h-3 bg-gray-200 dark:bg-dark-border rounded w-2/3"></div>
